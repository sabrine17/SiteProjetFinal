...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<button class='"menu-toggle"' id="buttonP" onclick="this.classList.toggle('opened');this.setAttribute('aria-expanded', this.classList.contains('opened'))" aria-label="Main Menu">
