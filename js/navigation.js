...
// ouverture bloc de contenu conteneur 23
(function(){
	let project = document.getElementsByClassName("petitconteneur23")
...
(function(){
	let project = document.getElementsByClassName("petitconteneur24")
	let close = document.getElementsByClassName("close")
	let descOuvert = false
	for(const projects of project){
		projects.addEventListener("click", function(event){
